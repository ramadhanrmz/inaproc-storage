    ...
    <div id="create-modal" class="bg-white rounded-2xl shadow-2xl w-full max-w-3xl mx-4 transform scale-95 opacity-0 transition-all duration-300 max-h-[90vh] flex flex-col">
        ...
        <div class="flex items-center justify-between px-6 py-4 border-b border-gray-100 shrink-0">
            <div class="flex items-center space-x-3">
                ...
                <div>
                    <h3 class="text-lg font-black text-gray-800">Tambah Data Akun</h3>
                    <p class="text-[10px] text-gray-400 font-bold uppercase tracking-widest">LPSE Provinsi NTB</p>
                </div>
            </div>
            <button onclick="closeCreateModal()" class="w-8 h-8 rounded-lg bg-gray-100 hover:bg-red-100 text-gray-400 hover:text-red-500 flex items-center justify-center transition-all">
        ...
        <form id="create-form" class="overflow-y-auto flex-1" onsubmit="return submitCreateForm(event)">
            ...
            <div class="p-6 space-y-5">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="nama" id="create-nama" class="w-full border border-gray-200 rounded-xl px-4 py-2.5 bg-gray-50 focus:bg-white text-sm transition-all focus:ring-2 focus:ring-blue-400" required placeholder="Contoh: Muhajidin, S.Pd., MM">
                    </div>
                    <div>
                        ...
                        <input list="create_list_opd" name="opd" id="create-opd" class="w-full border border-gray-200 rounded-xl px-4 py-2.5 bg-gray-50 focus:bg-white text-sm transition-all focus:ring-2 focus:ring-blue-400" required placeholder="Ketik atau pilih OPD...">
                        <datalist id="create_list_opd">
                    ...
                    <div>
                        ...
                        <select name="status" id="create-status" class="w-full border border-gray-200 rounded-xl px-4 py-2.5 bg-gray-50 focus:bg-white text-sm transition-all focus:ring-2 focus:ring-blue-400" required>
                    ...
                    <div>
                        ...
                        <input type="text" name="user_id" id="create-user_id" class="w-full border border-gray-200 rounded-xl px-4 py-2.5 bg-gray-50 focus:bg-white text-sm transition-all focus:ring-2 focus:ring-blue-400" required placeholder="Contoh: MUHAJIDINPPK">
                    </div>
                    <div>
                        ...
                        <input type="number" name="nik" id="create-nik" oninput="if(this.value.length > 16) this.value = this.value.slice(0, 16);" class="w-full border border-gray-200 rounded-xl px-4 py-2.5 bg-gray-50 focus:bg-white text-sm transition-all focus:ring-2 focus:ring-blue-400" required placeholder="Maksimal 16 angka">
                    </div>
                    <div>
                        ...
                        <input type="number" name="nip" id="create-nip" oninput="if(this.value.length > 18) this.value = this.value.slice(0, 18);" class="w-full border border-gray-200 rounded-xl px-4 py-2.5 bg-gray-50 focus:bg-white text-sm transition-all focus:ring-2 focus:ring-blue-400" required placeholder="Maksimal 18 angka">
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 bg-gray-50 p-4 rounded-xl border border-gray-100">
                    <div>
                        ...
                        <input type="text" name="no_surat_permohonan" id="create-no_surat_permohonan" class="w-full border border-gray-200 rounded-xl px-4 py-2.5 bg-white text-sm transition-all focus:ring-2 focus:ring-blue-400" required>
                    </div>
                    <div>
                        ...
                        <select name="perihal_permohonan" id="create-perihal_permohonan" class="w-full border border-gray-200 rounded-xl px-4 py-2.5 bg-white text-sm transition-all focus:ring-2 focus:ring-blue-400 font-bold" required>
                    ...
                    <div>
                        ...
                        <input type="text" name="no_sk" id="create-no_sk" class="w-full border border-gray-200 rounded-xl px-4 py-2.5 bg-white text-sm transition-all focus:ring-2 focus:ring-blue-400" required>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="pangkat_gol" id="create-pangkat_gol" class="w-full border border-gray-200 rounded-xl px-4 py-2.5 bg-gray-50 focus:bg-white text-sm transition-all focus:ring-2 focus:ring-blue-400" required>
                    </div>
                    <div>
                        ...
                        <input type="text" name="jabatan" id="create-jabatan" class="w-full border border-gray-200 rounded-xl px-4 py-2.5 bg-gray-50 focus:bg-white text-sm transition-all focus:ring-2 focus:ring-blue-400" required>
                    </div>
                    <div>
                        ...
                        <div class="flex items-stretch focus-within:ring-2 focus-within:ring-blue-400 rounded-xl transition-all">
                            ...
                            <input type="number" name="no_hp" id="create-no_hp" oninput="if(this.value.length > 12) this.value = this.value.slice(0, 12);" class="w-full border border-gray-200 bg-gray-50 focus:bg-white transition-all rounded-none rounded-r-xl px-4 py-2.5 text-sm outline-none focus:ring-0" required placeholder="87865xxxxxx">
                        </div>
                    </div>
                    <div>
                        ...
                        <input type="date" name="tanggal_daftar" id="create-tanggal_daftar" class="w-full border border-gray-200 rounded-xl px-4 py-2.5 bg-gray-50 focus:bg-white text-sm transition-all focus:ring-2 focus:ring-blue-400" required>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <div class="flex space-x-6">
                            <label class="inline-flex items-center"><input type="radio" name="sumber" value="Fisik" class="form-radio text-blue-500" required checked><span class="ml-2 text-sm">Fisik</span></label>
                            <label class="inline-flex items-center"><input type="radio" name="sumber" value="Digital" class="form-radio text-blue-500" required><span class="ml-2 text-sm">Digital</span></label>
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="flex space-x-6">
                            <label class="inline-flex items-center"><input type="radio" name="jenis_data" value="Katalog v.6" class="form-radio text-blue-500" required checked><span class="ml-2 text-sm">Katalog v.6</span></label>
                ...
                <div>
                    ...
                    <textarea name="alamat" id="create-alamat" rows="2" class="w-full border border-gray-200 rounded-xl px-4 py-2.5 bg-gray-50 focus:bg-white text-sm transition-all focus:ring-2 focus:ring-blue-400" required></textarea>
                </div>
            </div>

            {{-- Footer --}}
            <div class="px-6 py-4 border-t border-gray-100 flex justify-end gap-3 shrink-0 bg-gray-50/50 rounded-b-2xl">
                <button type="button" onclick="closeCreateModal()" class="bg-white border border-gray-300 text-gray-700 px-5 py-2.5 rounded-xl hover:bg-gray-50 font-bold text-sm transition-all">Batal</button>
                <button type="submit" id="create-submit-btn" class="bg-blue-600 text-white px-6 py-2.5 rounded-xl hover:bg-blue-700 shadow-lg font-black text-sm transition-all flex items-center gap-2">
            ...
            {{-- Error container --}}
            <div id="create-modal-errors" class="hidden px-6 pb-4">
                <div class="bg-red-50 rounded-xl p-4 border border-red-200">
                    <p class="text-sm font-bold text-red-600 mb-2">Gagal menyimpan:</p>
                    <ul id="create-modal-error-list" class="space-y-1 text-sm text-red-500"></ul>
                </div>
            </div>
        </form>
    </div>
...
function openCreateModal() {
    ...
    const errBox = document.getElementById('create-modal-errors');
    ...
    document.getElementById('create-tanggal_daftar').value = today;
...
function submitCreateForm(e) {
    ...
    const errBox = document.getElementById('create-modal-errors');
    const errList = document.getElementById('create-modal-error-list');
    ...
    .catch(err => {
        btn.disabled = false;
        btn.innerHTML = '<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/></svg> Simpan Data';
...
document.addEventListener('keydown', function(e) {
    if (e.key === 'Escape' && !document.getElementById('create-modal-overlay').classList.contains('hidden')) {
        closeCreateModal();
    }
});
</script>
